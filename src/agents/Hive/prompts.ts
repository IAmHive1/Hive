...
export const HiveSystemPrompt = new PromptTemplate({
  schema: z.object({
...
export const HiveAssistantPrompt = new PromptTemplate({
  schema: z
    .object({
...
export const HiveUserPrompt = new PromptTemplate({
  schema: z
    .object({
      input: z.string(),
      meta: z
...
export const HiveUserEmptyPrompt = new PromptTemplate({
  schema: z.object({}).passthrough(),
  template: `Message: Empty message.`,
});

export const HiveToolErrorPrompt = new PromptTemplate({
  schema: z
    .object({
      reason: z.string(),
    })
...
export const HiveToolInputErrorPrompt = new PromptTemplate({
  schema: z
    .object({
      reason: z.string(),
    })
...
export const HiveToolNoResultsPrompt = new PromptTemplate({
  schema: z.record(z.any()),
  template: `No results were found!`,
});

export const HiveToolNotFoundPrompt = new PromptTemplate({
  schema: z
    .object({
...
export const HiveSchemaErrorPrompt = new PromptTemplate({
  schema: z.object({}).passthrough(),
