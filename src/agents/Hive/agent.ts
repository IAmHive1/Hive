...
import { BaseRunner } from "@/agents/Hive/runners/base.js";
import { GraniteRunner } from "@/agents/Hive/runners/granite/runner.js";
...
export interface HiveInput {
  ...
  templates?: Partial<HiveAgentTemplates>;
}

export class HiveAgent extends BaseAgent<HiveRunInput, HiveRunOutput, HiveRunOptions> {
  public readonly emitter = Emitter.root.child<HiveCallbacks>({
  ...
  constructor(protected readonly input: HiveInput) {
    super();
  ...
  get meta(): AgentMeta {
    ...
    return {
      ...
      tools,
      description:
        "The Hive framework demonstrates its ability to auto-correct and adapt in real-time, improving the overall reliability and resilience of the system.",
      ...(tools.length > 0 && {
        extraDescription: [
